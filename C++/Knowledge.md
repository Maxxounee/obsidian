...
| `%i`           | Целое число в десятичной, шестнадцатеричноый или восмьеричной системах. `Приводится к типу int`         |
| `%u`           | Целое беззнаковое (unsigned) число в десятичной форме. `Приводится к типу unsigned int`                 |
| `%o`           | Целое беззнаковое (unsigned) число в восьмеричной форме `Приводится к типу int`                         |
| `%x`           | Целое беззнаковое (unsigned) число в шестнадцатеричной форме `Приводится к типу int`                    |
| `%f` `%e` `%g` | Вещественное число в виде десятичной дроби. `Приводится к типу float`                                   |
| `%e`           | Вещественное число в экспоненциальной форме                                                             |
| `%c`           | Символ в соответствии с текущей кодовой таблицей                                                        |
| `%s`           | Строка (последовательность символов). `Приводится к типу char`                                          |
| `%%`           | Запись символа `%` в форматной строке. Читает до первого пробела, перевода строки или символа табуляции |
## Модификаторы преобразований для scanf
| Name                    | Description                                                                                                |
| ----------------------- | ---------------------------------------------------------------------------------------------------------- |
