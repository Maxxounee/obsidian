...
## Необходимые атрибуты нейронной сети
### _Функции активации_:

* `ReLU` - применяется в полносвязных и сверточных сетях
* `Sigmoid` - применяется в рекуррентных нейронных сетях и в задачах классификации
* `Tanh` - применяется в рекуррентных нейронных сетях
* `Softmax` - применяется при классификации, после последнего слоя нейронной сети, трансформеры
...
_Метрика - критерий для оценки качества модели._

### _Оптимизаторы градиентного спуска:_
...
![[./assets/Pasted image 20250403143549.png]]
